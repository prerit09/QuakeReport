...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject eqInfo = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray features = eqInfo.optJSONArray("features");
            for(int i=0;i<features.length();i++){
                JSONObject eqFeature = features.getJSONObject(i);
                JSONObject properties = eqFeature.getJSONObject("properties");
